...
`;
    ...
    try {
      ...
      const errorInfo = OpenAIErrorHandler.handleError(e, {
        ...
        method: 'generatePersonalizedMessage'
      });
      console.error('[NOTIFICATION PERSONALIZED ERROR]', errorInfo.message);
...
`;
    ...
    try {
      ...
      await OpenAIUsageTracker.trackUsage(
        ...
        'notificationOptimalTime',
        userId,
        '/api/notifications/optimal-time',
        response.model
      );
      ...
      const errorInfo = OpenAIErrorHandler.handleError(e, {
        service: 'NotificationService',
        method: 'calculateOptimalSendTime'
      });
      console.error('[NOTIFICATION OPTIMAL TIME ERROR]', errorInfo.message);
...
`;
    ...
    try {
      ...
      console.error('[NOTIFICATION ABTEST ERROR]', errorInfo.message);
...
`;
    ...
    try {
      ...
      const errorInfo = OpenAIErrorHandler.handleError(e, {
        service: 'NotificationService',
        method: 'generateSegmentedCampaign'
      });
      console.error('[NOTIFICATION SEGMENTED ERROR]', errorInfo.message);
