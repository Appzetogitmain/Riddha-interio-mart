          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <div className="flex flex-wrap gap-3">
                ...
                {images.length < 5 && (
                  <label className="w-16 h-16 rounded-lg border-2 border-dashed flex items-center justify-center cursor-pointer hover:bg-slate-50">
            ...
            {isPickup && (
              <div>
                ...
                {video ? (
                  ...
                  <label className="w-full h-32 rounded-lg border-2 border-dashed flex flex-col items-center justify-center cursor-pointer hover:bg-slate-50">
            ...
            <button type="submit" disabled={isSubmitting} className="w-full py-3 bg-seller-primary hover:opacity-90 text-white font-bold rounded-xl disabled:opacity-50">
