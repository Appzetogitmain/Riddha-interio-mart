    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-xs animate-fade-in">
      <div className="bg-white rounded-3xl max-w-lg w-full p-6 shadow-2xl relative border border-gray-100 overflow-hidden">
        ...
        <div className="flex items-center gap-2 mb-4">
          ...
          <div>
            <h3 className="text-lg font-bold text-gray-900">Why Gemini Recommended This</h3>
            <p className="text-xs text-gray-500">AI Design Match Analysis</p>
          </div>
        </div>

        {/* Product Preview Header */}
        <div className="flex items-center gap-4 p-3 bg-gray-50 rounded-2xl mb-5">
          <img
          ...
          <div>
            ...
            <div className="inline-flex items-center gap-1.5 mt-1 text-[11px] font-bold text-emerald-800 bg-emerald-100/80 px-2 py-0.5 rounded-md">
        ...
        {loading ? (
          ...
          <div className="space-y-4">
            ...
            {/* Key Match Points */}
            <div>
              <h5 className="text-xs font-bold uppercase tracking-wider text-gray-400 mb-2">Key Compatibility Points</h5>
        ...
        <div className="mt-6 pt-4 border-t border-gray-100 flex items-center justify-between">
          <span className="text-xs text-gray-400">Powered by Gemini AI Engine</span>
          <button
            onClick={onClose}
            className="px-5 py-2.5 bg-emerald-900 hover:bg-emerald-800 text-emerald-300 text-xs font-semibold rounded-xl shadow-xs transition-colors"
          >
            Got It
          </button>
        </div>
